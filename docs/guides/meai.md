...
The Gamma SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Gamma
```
...
using var client = new GammaClient(
    apiKey: Environment.GetEnvironmentVariable("GAMMA_API_KEY")!);
