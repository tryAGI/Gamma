...
namespace Gamma
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Gamma.AutoSDKRetryOptions Retry { get; set; } = new global::Gamma.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Gamma.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Gamma.IAutoSDKHook>();
        ...
        public global::Gamma.AutoSDKClientOptions AddHook(
            global::Gamma.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Gamma.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Gamma.AutoSDKClientOptions UseAuthorizationProvider(
            global::Gamma.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Gamma.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Gamma.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Gamma.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Gamma.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Gamma.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Gamma.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Gamma.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Gamma.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Gamma.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Gamma.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Gamma.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Gamma.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Gamma.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Gamma.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Gamma.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Gamma.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Gamma.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Gamma.IAutoSDKHook, global::Gamma.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Gamma.AutoSDKHookContext context)
        {
