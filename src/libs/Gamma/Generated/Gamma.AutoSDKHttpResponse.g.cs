...
namespace Gamma
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::Gamma.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::Gamma.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::Gamma.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::Gamma.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::Gamma.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::Gamma.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::Gamma.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::Gamma.ApiException exception)
        ...
        private static global::Gamma.AutoSDKRequestOptions CloneRequestOptions(
            global::Gamma.AutoSDKRequestOptions? source)
        {
            var clone = new global::Gamma.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
