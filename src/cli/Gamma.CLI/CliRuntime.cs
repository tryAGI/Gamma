...
internal static class CliRuntime
{
    ...
    public static async Task<global::Gamma.GammaClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Gamma.ApiException exception)
    {
        var builder = new StringBuilder();
