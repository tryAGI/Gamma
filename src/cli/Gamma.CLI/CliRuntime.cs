...
{
    private const string UserSecretsId = "Gamma.CLI";
    private const string UserSecretApiKeyName = "GAMMA_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"GAMMA_API_KEY"];
    private const string CredentialFileDirectoryName = ".gamma";

    public static async global::System.Threading.Tasks.Task<global::Gamma.GammaClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        return new global::Gamma.GammaClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("GAMMA_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Gamma.ApiException exception)
    {
        var builder = new StringBuilder();
